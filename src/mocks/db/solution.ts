...
const data = {
  ...
  solution_filter_options: [
    { id: 'quick-popular', kind: 'quick', label: 'Most popular', value: 'popular' },
    { id: 'quick-latest', kind: 'quick', label: 'Latest', value: 'latest' },
    { id: 'sort-likes', kind: 'sort', label: 'Most likes', value: 'likes' },
  ],
  solution_authors: [
    { id: 'author-system', name: 'System', role: 'Editorial', avatar_color: '#94a3b8' },
    { id: 'author-lee', name: 'Lee', role: 'TypeScript · Demo', avatar_color: '#0ea5e9' },
  ],
  solution_badges: [
