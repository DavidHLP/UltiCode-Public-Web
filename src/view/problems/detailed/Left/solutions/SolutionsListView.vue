...
const filteredItems = computed(() => {
  ...
  return feedItems.value.filter((item) => {
    ...
    const matchesTopic = topicFilter.value === 'all' || item.topic === topicFilter.value
    const matchesQuery =
      !query ||
        ...
        <div class="flex flex-wrap items-center gap-3">
          ...
          <div class="ml-auto flex flex-wrap items-center gap-2">
            <Menubar class="border-border">
              <MenubarMenu>
                <MenubarTrigger class="flex items-center gap-2 px-3 py-1 text-xs">
            ...
            <Menubar class="border-border">
              <MenubarMenu>
                ...
                <MenubarContent class="min-w-[160px] p-1">
                  ...
                  >
                    <span>{{ option.label }}</span>
                    <span v-if="quickFilter === option.value" class="text-primary">●</span>
                  </MenubarItem>
                </MenubarContent>
              </MenubarMenu>
            </Menubar>
        ...
        <div class="space-y-2 text-xs">
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              :class="option.value === topicFilter ? 'bg-primary/10 text-primary' : ''"
