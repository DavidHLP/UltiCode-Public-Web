      ...
      h('li', { class: 'space-y-2' }, [
        h('div', { class: 'flex items-start gap-3' }, [
              ...
              default: () => [
                props.comment.avatar
                  ...
                  : h(
                      ...
                      { default: () => props.comment.author.username.slice(0, 2).toUpperCase() },
                    ),
              ],
            },
          ),
          h('div', { class: 'min-w-0 flex-1 space-y-1' }, [
            h(
              ...
              [
                ...
                props.comment.isPinned
                  ? h('span', { class: 'inline-flex items-center gap-1 text-emerald-700' }, [
                      h(Pin, { class: 'h-3 w-3' }),
                      ' Pinned',
                    ])
                  : null,
                props.comment.isLocked
                  ? h('span', { class: 'inline-flex items-center gap-1 text-amber-700' }, [
                      h(Lock, { class: 'h-3 w-3' }),
                      ' Locked',
                    ])
                  : null,
              ],
            ...
            h('div', { class: 'flex items-center gap-3 text-[11px] text-muted-foreground' }, [
        ...
        props.comment.replies && props.comment.replies.length
          ? h(
              ...
              props.comment.replies.map((child) =>
                h(resolveComponent('CommentNode'), { comment: child, key: child.id }),
              ),
            )
          : null,
      ])
