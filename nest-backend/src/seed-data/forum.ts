...
const data = {
  ...
  forum_posts: [
    ...
    {
      id: 'post-valid-parentheses',
      community_id: communityId,
      user_id: 'shadcn',
      title: 'Is there a way without stack?',
      body: 'Can Valid Parentheses be solved with O(1) space if we only had one type of bracket?',
      tags: ['valid-parentheses', 'stack'],
      flair_type: 'question',
      vote_state: 'neutral',
      is_saved: false,
      impressions: 150,
    ...
    {
      id: 'post-trapping-water',
      community_id: communityId,
      user_id: 'stack_unwind',
      title: 'DP vs Two Pointers for Rain Water',
      body: 'I find the DP array approach easier to understand than two pointers. Opinions?',
      tags: ['trapping-rain-water', 'dynamic-programming'],
      flair_type: 'discussion',
      vote_state: 'upvoted',
      is_saved: true,
      impressions: 300,
